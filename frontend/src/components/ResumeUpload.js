  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass-card p-10">
        ...
        <div
          className={`relative border-2 border-dashed rounded-2xl p-16 text-center cursor-pointer transition-all duration-300 ${isDragging
            ? 'border-amber-500 bg-amber-500/5 scale-[1.02] shadow-glow'
        ...
        >
          {isUploading ? (
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-xl text-cream-100 font-semibold mb-2">Processing Resume</p>
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="relative mb-6">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500/20 to-amber-600/20 flex items-center justify-center border border-amber-500/30">
              ...
              <p className="text-xl text-cream-100 mb-2 font-semibold">
                Drop your resume here
              </p>
              <p className="text-charcoal-400 mb-6 text-sm">or click to browse</p>
